...
{
    public partial class frm_Screen_1 : Form
    {
        public frm_Screen_1()
        {
            InitializeComponent();
        ...
        public frm_Screen_1(string ID, string M_Name)
        {
            InitializeComponent();
        ...
        private void frm_Screen_1_Load(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from Add_Movie_Details where Status = 'On' and Screen = '1'", Con);
